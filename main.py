...
mixer.music.load("game_bgm.mp3")  # background game music
mixer.music.play(-1)
# screen setup
...
alien_soldier_death_img = pygame.image.load("alien_soldier_death_image.png")
soldier_explosion = []
# alien_death_explosion
alien_monster_death_img = pygame.image.load("alien_monster_death_image.png")
monster_explosion = []
# boss_alien explosion
alien_boss_ship_img = pygame.image.load("alien_boss_ship.png")
scaled_boss_ship_img = pygame.transform.scale(alien_boss_ship_img, (100, 100))
alien_boss_death_img = pygame.image.load("alien_boss_death_image.png")
...
for i in range(no_of_monster_aliens):  # display multiple monster_aliens
    alien_monster_img.append(pygame.image.load('alien_monster_image.png'))
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:  # when a key is pressed
            ...
            if event.key == pygame.K_SPACE and not game_over_flag:
                laser_sound = mixer.Sound("spaceship_laser_bgm.mp3")  # laser sound effect
                laser_sound.play()
    ...
    if not game_over_flag:
        ...
        for bullet in bullets[:]:  # create multiple bullet at same time
            for i in range(no_of_aliens):  # if bullet hit alien_soldiers
                ...
                if distance < 27:
                    alien_soldier_death_sound = mixer.Sound("alien_death_bgm.mp3")  # alien_soldier_death sound effect
                ...
                for j in range(no_of_monster_aliens):  # if bullet hit  alien_monsters
                    ...
                    if distance < 27:
                        alien_monster_death_sound = mixer.Sound(
                            "alien_monster_death_bgm.mp3")  # alien_soldier_death sound effect
                ...
                for k in range(no_of_boss_aliens):  # if bullet hit  alien_monsters
                    ...
                    if distance < 27:
                        ...
                        if boss_health <= 0:
                            ...
                            alien_boss_death_sound = mixer.Sound("alien_boss_death_bgm.mp3")
